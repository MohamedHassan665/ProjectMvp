...
// Time Activity to show books  of Time
...
public class Time extends AppCompatActivity implements View.OnClickListener , Contract {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageHome.setOnClickListener(new View.OnClickListener() {
         ...
         array= new ArrayList<>();
         MainPresenter mainPresenter=new MainPresenter(this::loadData,this,"time");
        ...
        //override from method to send information to MoreInformation Activity
         adapter.setOnClickListener(new Adapter.onItemClickedListener() {
            ...
            public void onIteamClicked(int postion) {
                ...
                Intent intent=new Intent(Time.this, MoreInformation.class);
    ...
    @Override
    public void onClick(View v) {
        Intent intent=new Intent(Time.this, Faviourt.class);
