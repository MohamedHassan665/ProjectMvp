...
// Life Activity to show books  of Life
...
public class Life extends AppCompatActivity implements View.OnClickListener, Contract {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        array= new ArrayList<>();
        MainPresenter mainPresenter=new MainPresenter(this::loadData,this,"life");
       ...
       adapter=new Adapter(array,this);// send Information to adapter
        recyclerView.setAdapter(adapter);//put iteams in recyclerView
